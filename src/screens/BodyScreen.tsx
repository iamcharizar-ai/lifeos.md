...
import { WORKOUT_TYPES, type SkillState, type SkillStatus } from '../config/skills'
...
export function BodyScreen({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* The constellation */}
      <SkillTree skills={skills} onSkill={onSkill} />

      <div className="chip border border-dashed border-line p-3 text-center text-[10px] text-dim">
        tap a node for milestones &amp; actions · tree data lives in the vault (2026 Goals ·
        Calisthenics Progress) · locked = prerequisites, never XP — reality always wins
      </div>
    </div>
  )
}
